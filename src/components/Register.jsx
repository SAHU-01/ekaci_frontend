...
const Register = () => {
  //let btnChange = `<button style="color:green;border-radius:25px">Connected to Metamask</button>`;
  //let btnOriginal = `<button style="color:#38BDF8;border-radius:25px">Connect with Metamask</button>`;
